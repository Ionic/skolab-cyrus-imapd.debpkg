...

{
  ...
  { IMAPOPT_ANNOTATION_CALLOUT, "annotation_callout", 0, OPT_STRING,
    ...
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_APS_TOPIC, "aps_topic", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) NULL),
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_ARCHIVE_ENABLED, "archive_enabled", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_ARCHIVE_DAYS, "archive_days", 0, OPT_INT,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 7),
    (union config_value)((long) 7),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_ARCHIVE_MAXSIZE, "archive_maxsize", 0, OPT_INT,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1024),
    (union config_value)((long) 1024),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_ARCHIVE_KEEPFLAGGED, "archive_keepflagged", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_BOUNDARY_LIMIT, "boundary_limit", 0, OPT_INT,
    ...
    (union config_value)((long) 1000),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CALDAV_ALLOWATTACH, "caldav_allowattach", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1),
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CALDAV_ALLOWSCHEDULING, "caldav_allowscheduling", 0, OPT_ENUM,
    ...
    { { "off" , IMAP_ENUM_CALDAV_ALLOWSCHEDULING_OFF },
      ...
      { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CALDAV_CREATE_ATTACH, "caldav_create_attach", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1),
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CALDAV_CREATE_DEFAULT, "caldav_create_default", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1),
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CALDAV_CREATE_SCHED, "caldav_create_sched", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1),
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_CREATEONPOST, "createonpost", 0, OPT_SWITCH,
    "2.5.0", IMAPOPT_AUTOCREATE_POST,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CONVERSATIONS, "conversations", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CONVERSATIONS_COUNTED_FLAGS, "conversations_counted_flags", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) NULL),
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CONVERSATIONS_DB, "conversations_db", 0, OPT_STRINGLIST,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) "skiplist"),
    (union config_value)((const char *) "skiplist"),
    { { "skiplist" , IMAP_ENUM_ZERO },
      { "sql" , IMAP_ENUM_ZERO },
      { "twoskip" , IMAP_ENUM_ZERO },
      { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_CONVERSATIONS_EXPIRE_DAYS, "conversations_expire_days", 0, OPT_INT,
    NULL, IMAPOPT_ZERO,
  ...
  { IMAPOPT_EVENT_EXTRA_PARAMS, "event_extra_params", 0, OPT_BITFIELD,
    ...
    { { "bodyStructure" , IMAP_ENUM_EVENT_EXTRA_PARAMS_BODYSTRUCTURE },
      ...
      { "vnd.cmu.mailboxACL" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_CMU_MAILBOXACL },
      ...
      { "vnd.fastmail.clientId" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_CLIENTID },
      { "vnd.fastmail.sessionId" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_SESSIONID },
      { "vnd.fastmail.convExists" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_CONVEXISTS },
      { "vnd.fastmail.convUnseen" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_CONVUNSEEN },
      { "vnd.fastmail.cid" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_CID },
      { "vnd.fastmail.counters" , IMAP_ENUM_EVENT_EXTRA_PARAMS_VND_FASTMAIL_COUNTERS },
      { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_EVENT_GROUPS, "event_groups", 0, OPT_BITFIELD,
    ...
    { { "message" , IMAP_ENUM_EVENT_GROUPS_MESSAGE },
      ...
      { "calendar" , IMAP_ENUM_EVENT_GROUPS_CALENDAR },
      { "applepushservice" , IMAP_ENUM_EVENT_GROUPS_APPLEPUSHSERVICE },
      { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_HTTPMODULES, "httpmodules", 0, OPT_BITFIELD,
    ...
    { { "caldav" , IMAP_ENUM_HTTPMODULES_CALDAV },
      ...
      { "freebusy" , IMAP_ENUM_HTTPMODULES_FREEBUSY },
      { "ischedule" , IMAP_ENUM_HTTPMODULES_ISCHEDULE },
      { "jmap" , IMAP_ENUM_HTTPMODULES_JMAP },
      { "rss" , IMAP_ENUM_HTTPMODULES_RSS },
      { "tzdist" , IMAP_ENUM_HTTPMODULES_TZDIST },
      { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_METAPARTITION_FILES, "metapartition_files", 0, OPT_BITFIELD,
    ...
    { { "header" , IMAP_ENUM_METAPARTITION_FILES_HEADER },
      ...
      { "archivecache" , IMAP_ENUM_METAPARTITION_FILES_ARCHIVECACHE },
      { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_NNTPTIMEOUT, "nntptimeout", 0, OPT_INT,
    ...
    (union config_value)((long) 3),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_NOTESMAILBOX, "notesmailbox", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) NULL),
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_SASL_MINIMUM_LAYER, "sasl_minimum_layer", 0, OPT_INT,
    ...
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_BATCHSIZE, "search_batchsize", 0, OPT_INT,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 20),
    (union config_value)((long) 20),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_NORMALISATION_MAX, "search_normalisation_max", 0, OPT_INT,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1000),
    (union config_value)((long) 1000),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_ENGINE, "search_engine", 0, OPT_ENUM,
    NULL, IMAPOPT_ZERO,
    (union config_value)((enum enum_value) IMAP_ENUM_SEARCH_ENGINE_NONE),
    (union config_value)((enum enum_value) IMAP_ENUM_SEARCH_ENGINE_NONE),
    { { "none" , IMAP_ENUM_SEARCH_ENGINE_NONE },
      { "squat" , IMAP_ENUM_SEARCH_ENGINE_SQUAT },
      { "sphinx" , IMAP_ENUM_SEARCH_ENGINE_SPHINX },
      { "xapian" , IMAP_ENUM_SEARCH_ENGINE_XAPIAN },
      { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_INDEX_HEADERS, "search_index_headers", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 1),
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_INDEXED_DB, "search_indexed_db", 0, OPT_STRINGLIST,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) "twoskip"),
    (union config_value)((const char *) "twoskip"),
    { { "flat" , IMAP_ENUM_ZERO },
  ...
  { IMAPOPT_SEARCH_SKIPDIACRIT, "search_skipdiacrit", 0, OPT_SWITCH,
    ...
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SEARCH_SKIPHTML, "search_skiphtml", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_SOFT_NOAUTH, "soft_noauth", 0, OPT_SWITCH,
    ...
    (union config_value)((long) 1),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SORTCACHE_DB, "sortcache_db", 0, OPT_STRINGLIST,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) "twoskip"),
    (union config_value)((const char *) "twoskip"),
    { { "skiplist" , IMAP_ENUM_ZERO },
  ...
  { IMAPOPT_SPECIALUSEALWAYS, "specialusealways", 0, OPT_SWITCH,
    ...
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SPHINX_TEXT_EXCLUDES_ODD_HEADERS, "sphinx_text_excludes_odd_headers", 0, OPT_SWITCH,
    NULL, IMAPOPT_ZERO,
    (union config_value)((long) 0),
    (union config_value)((long) 0),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SPHINX_SOCKET, "sphinx_socket", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) "{configdirectory}/socket/sphinx"),
    (union config_value)((const char *) "{configdirectory}/socket/sphinx"),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_SPHINX_PIDFILE, "sphinx_pidfile", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) "/var/run/sphinx.pid"),
    (union config_value)((const char *) "/var/run/sphinx.pid"),
    { { NULL, IMAP_ENUM_ZERO } } },
  ...
  { IMAPOPT_TLS_CA_FILE, "tls_ca_file", 0, OPT_STRING,
    "2.5.0", IMAPOPT_TLS_CLIENT_CA_FILE,
    (union config_value)((const char *) NULL),
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_TLS_CA_PATH, "tls_ca_path", 0, OPT_STRING,
    "2.5.0", IMAPOPT_TLS_CLIENT_CA_DIR,
    (union config_value)((const char *) NULL),
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_TLSCACHE_DB, "tlscache_db", 0, OPT_STRINGLIST,
    "2.5.0", IMAPOPT_TLS_SESSIONS_DB,
    (union config_value)((const char *) "twoskip"),
    (union config_value)((const char *) "twoskip"),
    { { "skiplist" , IMAP_ENUM_ZERO },
      { "sql" , IMAP_ENUM_ZERO },
  ...
  { IMAPOPT_LMTP_CATCHALL_MAILBOX, "lmtp_catchall_mailbox", 0, OPT_STRING,
    ...
    (union config_value)((const char *) NULL),
    { { NULL, IMAP_ENUM_ZERO } } },
  { IMAPOPT_DEFAULTSEARCHTIER, "defaultsearchtier", 0, OPT_STRING,
    NULL, IMAPOPT_ZERO,
    (union config_value)((const char *) ""),
    (union config_value)((const char *) ""),
    { { NULL, IMAP_ENUM_ZERO } } },
